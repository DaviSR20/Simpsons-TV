...
donut_img = pygame.image.load(os.path.join(BASE_DIR, "img", "Donut.png"))
body_img  = pygame.image.load(os.path.join(BASE_DIR, "img", "body.png"))
tail_img  = pygame.image.load(os.path.join(BASE_DIR, "img", "tail.png"))
...
def seleccionar_personaje_paisaje():
    personajes = cargar_lista_imagenes(
        os.path.join(BASE_DIR, "img", "heads"),
    ...
    paisajes = [
        pygame.transform.scale(
            pygame.image.load(os.path.join(BASE_DIR, "img", "fons", nombre)),
            (ANCHO, ALTO)
        )
